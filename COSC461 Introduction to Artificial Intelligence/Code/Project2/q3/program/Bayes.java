...
public class Bayes {
    ...
    public int validate() throws IOException {
        ...
        int predictedClass = classify(validationRecord.attributes);

        //error if predicted and actual classes do not match
        if (predictedClass != validationRecord.className) {
            System.out.println("Error: predicted " + predictedClass + " != " + validationRecord.className);
            return 1;
        }
